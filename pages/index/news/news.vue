<template>
	<view>
		<view class="content">
			<!-- url传参 会遍历数组 -->
			<navigator v-for="(item,index) in newsList" :url="'../news_detail/news_detail?nid='+item.id" open-type="navigate" class="content_list">
			...
			<view class="item_list">
				<navigator v-for="(item,index) in newsList" :url="'../news_detail/news_detail?nid='+item.id" open-type="navigate" class="item" >通知：关于人工智能
