	...
	<view>
		...
		<view class="pj">
			...
			<view v-if="project.length!=0" class="pj_detail">
				<view  v-for="(item,index) in project" class="pj_list" :key="item.id" @click="to_Detail(item.id)">
		...
		<view class="hon" @click="to_Show">
			...
			<view v-if="competition.length!=0" >
					<view class="competition" v-for="(item,index) in competition" :key="item.id">
			...
			<view v-if="paper.length!=0" >
				<view class="competition" v-for="(item,index) in paper" :key="item.id">
					<view class="item" v-if="item.display=='1'">
						<image mode="widthFix" src="https://ns-strategy.cdn.bcebos.com/ns-strategy/upload/fc_big_pic/part-00662-2358.jpg"></image>
						<view class="block1">
							<text>论文</text>
			...
			<view v-if="patent.length!=0">
				<view v-for="(item,index) in patent" :key="item.id" class="competition">
					<view class="item" v-if="item.display=='1'">
						<image mode="widthFix" src="https://ns-strategy.cdn.bcebos.com/ns-strategy/upload/fc_big_pic/part-00662-2358.jpg"></image>
						<view class="block1">
							<text>专利</text>
