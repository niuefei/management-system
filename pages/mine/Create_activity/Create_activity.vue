	...
	<view>
		<form>
			<view class="cu-form-group">
				...
				<input placeholder="请输入活动名称" name="name" v-model="formData.name">
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group">
				...
				<input placeholder="请输入活动地点" name="site" v-model="formData.site">
			</view>
			<view class="cu-form-group">
				<view class="title">主办单位:</view>
				<input placeholder="请输入举办单位" name="host" v-model="formData.host">
			</view>
