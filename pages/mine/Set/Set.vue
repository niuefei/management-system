<template>
	<view class="">
		...
		<view class="cu-form-group">
			...
			<input v-model="userInfo.userName" placeholder="请输入昵称" class="name_input"></input>
		</view>
		<view class="cu-form-group">
		...
		<view class="cu-form-group">
			...
			<input v-model="userInfo.job" placeholder="请输入职业" disabled class="name_input"></input>
		</view>
		<view class="cu-form-group">
			<view class="title">所属单位</view>
			<input  disabled v-model="userInfo.unit" class="name_input"></input>
		</view>
